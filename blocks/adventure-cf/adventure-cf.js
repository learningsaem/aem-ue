        ...
        += `<div class="content-fragment-hero">
            <div class="content-fragment-image">
                <picture>
                    ...
                    <img src="${getAEMHost()}${cfPrimaryImagePath}?width=1200&format=webply&optimize=medium" alt="${data[keys.title]}" fetchpriority="high" loading="lazy" data-aue-type="media" data-aue-prop="${keys.primaryImage}">
                </picture>
            </div>
